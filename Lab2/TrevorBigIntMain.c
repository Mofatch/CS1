 ...
 * 	Lab Group:	Lab11
 *
 * 	Description: These functions allow the storage of non-negative integers
 * 	much larger than possible in primitive data types. It accomplishes this by
 * 	storing individual digits in nodes of a double linked list. The functions
 * 	provided include addition, multiplication, comparing, printing of BigInts
